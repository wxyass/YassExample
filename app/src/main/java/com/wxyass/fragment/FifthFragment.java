...
public class FifthFragment extends BaseFragment implements View.OnClickListener {
    ...
    public static class MyHandler extends Handler {
        ...
        // 软引用
        SoftReference<FifthFragment> fragmentRef;

        public MyHandler(FifthFragment fragment) {
            fragmentRef = new SoftReference<FifthFragment>(fragment);
        }

        @Override
        public void handleMessage(Message msg) {
            FifthFragment fragment = fragmentRef.get();
            if (fragment == null) {
                return;
            }
