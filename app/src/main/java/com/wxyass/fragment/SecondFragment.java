...
public class SecondFragment extends BaseFragment implements View.OnClickListener {
    ...
    public static class MyHandler extends Handler {
        ...
        // 软引用
        SoftReference<SecondFragment> fragmentRef;

        public MyHandler(SecondFragment fragment) {
            fragmentRef = new SoftReference<SecondFragment>(fragment);
        }

        @Override
        public void handleMessage(Message msg) {
            SecondFragment fragment = fragmentRef.get();
            if (fragment == null) {
                return;
            }
