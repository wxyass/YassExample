...
public class ThirdFragment extends BaseFragment implements View.OnClickListener {
    ...
    public static class MyHandler extends Handler {
        ...
        // 软引用
        SoftReference<ThirdFragment> fragmentRef;

        public MyHandler(ThirdFragment fragment) {
            fragmentRef = new SoftReference<ThirdFragment>(fragment);
        }

        @Override
        public void handleMessage(Message msg) {
            ThirdFragment fragment = fragmentRef.get();
            if (fragment == null) {
                return;
            }
